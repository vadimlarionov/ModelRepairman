...
class Ui_ModelRepairman(object):
    def setupUi(self, ModelRepairman):
        ...
        self.gridLayout.addWidget(self.tno_lineEdit, 3, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.c_lineEdit, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.to_lineEdit, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.calculateButton, 8, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.n_lineEdit, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.zi_lineEdit, 5, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.z_lineEdit, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.tableWidget, 1, 5, 10, 1)
        ...
        self.gridLayout.addWidget(self.precision_lineEdit, 7, 2, 1, 1)
        ...
        ModelRepairman.setTabOrder(self.z_lineEdit, self.calculateButton)
